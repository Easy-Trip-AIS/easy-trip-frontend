...
export default function Navbar() {
  ...
  return (
    <nav className="w-full h-16 bg-gradient-to-t from-indigo-100 to-white text-blue-900 backdrop-blur-md shadow-md flex items-center justify-between px-2 md:px-8 z-50 ">
