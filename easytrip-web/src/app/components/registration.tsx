...
export default function SignUpPage() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setErrors({ passwordMismatch: false, invalidEmail: false });
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 p-8 gap-4 min-h-screen">
        ...
        <div className="p-10 flex flex-col justify-between text-white h-full">
          <div className="flex flex-col items-start justify-center h-full text-left">
            <h2 className="text-6xl font-bold mb-4 text-black">Plan inspiring walks</h2>
        ...
        {/* Правий блок - форма */}
        <div className="bg-gray-100 rounded-xl shadow-lg w-full max-w-[700px] max-h-screen overflow-auto p-8 flex items-center pr-12 ml-10">
          <div className="w-full max-w-[600px] ml-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-green-400 text-white py-2 rounded-lg font-semibold hover:bg-green-600"
              >
                Sign Up
              </button>
              ...
              <p className="text-sm text-center mt-4">
                ...
                <a href="#" className="text-green-600">Sign In</a>
              </p>
            </form>
          </div>
        </div>
